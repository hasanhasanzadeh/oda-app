...
>
    ...
    <div class="flex items-center justify-center h-20 border-b dark:border-gray-700">
        <div class="flex items-center space-x-3 space-x-reverse">
            ...
            <div>
                <a href="{{route('home')}}" class="text-xl font-bold text-gray-800 dark:text-white">{{App\Models\Setting::first()->value('title')}}</a>
    ...
    <nav class="px-4 py-6">
        <div class="space-y-1">
            ...
            @endcan
                ...
                @endcan
                @can('product-all')
                    <a href="{{route('products.index')}}" class="flex items-center px-4 py-3 text-sm text-gray-700 transition-colors rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800">
                        <i class="fa-solid fa-layer-group ml-3 text-lg text-gray-500 dark:text-gray-400 "></i>
                        <span>محصولات</span>
                    </a>
                @endcan
                @can('payment-all')
                    <a href="{{route('payments.index')}}" class="flex items-center px-4 py-3 text-sm text-gray-700 transition-colors rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800">
                        <i class="ml-3 text-lg text-gray-500 dark:text-gray-400 fa-solid fa-money-check-dollar"></i>
            ...
            @endcan
                @can('content-all')
                    <a href="{{route('contents.index')}}" class="flex items-center px-4 py-3 text-sm text-gray-700 transition-colors rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800">
                        <i class="ml-3 text-lg text-gray-500 dark:text-gray-400 fas fa-level-down"></i>
                        <span>محتوا ها</span>
                    </a>
                @endcan
            @can('question-all')
                    <a href="{{route('questions.index')}}" class="flex items-center px-4 py-3 text-sm text-gray-700 transition-colors rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800">
                        <i class="ml-3 text-lg text-gray-500 dark:text-gray-400 fa-solid fa-question-circle"></i>
