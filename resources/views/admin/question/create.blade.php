...
@section('content')
    <div class="container px-4 sm:px-6 mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden mb-8">
            ...
            <form method="post" action="{{ route('questions.store') }}" enctype="multipart/form-data" class="px-6 py-4">
                @csrf
                ...
                <div class="mt-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea
                                ...
                                class="appearance-none block w-full bg-gray-200 text-gray-700 dark:bg-gray-700 dark:text-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                                required
