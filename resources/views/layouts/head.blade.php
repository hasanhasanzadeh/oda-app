        ...
        <div class="flex items-center space-x-4 space-x-reverse">
            ...
            <div x-data="{ notificationOpen: false }" class="relative">
                <button @click="notificationOpen = !notificationOpen" class="relative text-gray-600 dark:text-gray-300">
                    ...
                    <span class="absolute -top-2 left-3 flex items-center justify-center w-4 h-4 text-xs text-white bg-red-500 rounded-full">3</span>
                </button>
                    ...
                    <div class="py-2">
                        <div class="px-4 py-3 border-b dark:border-gray-700">
                            <div class="flex items-center justify-between">
                                ...
                                <button class="text-xs text-blue-600 dark:text-blue-400">علامت‌گذاری همه به عنوان خوانده شده</button>
                            </div>
                        </div>
                        <a href="#" class="block px-4 py-3 transition-colors hover:bg-gray-100 dark:hover:bg-gray-700 border-b dark:border-gray-700">
                            <div class="flex">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400">۱۵ دقیقه پیش</p>
                                </div>
                            </div>
                        </a>
                        <a href="#" class="block px-4 py-3 transition-colors hover:bg-gray-100 dark:hover:bg-gray-700 border-b dark:border-gray-700">
                            <div class="flex">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400">۱ ساعت پیش</p>
                                </div>
                            </div>
                        </a>
                        <a href="#" class="block px-4 py-3 transition-colors hover:bg-gray-100 dark:hover:bg-gray-700">
                            <div class="flex">
                                <div class="flex-shrink-0 ml-3">
                                ...
                                <div>
                                    <p class="text-sm text-gray-900 dark:text-white">
                                        <span class="font-semibold">هشدار سیستم:</span> استفاده از CPU بالا
                                    </p>
                                    <p class="text-xs text-gray-500 dark:text-gray-400">۲ ساعت پیش</p>
                                </div>
                            </div>
                        </a>
                        <div class="py-2 text-center border-t dark:border-gray-700">
                            <a href="#" class="text-sm font-medium text-blue-600 dark:text-blue-400">مشاهده همه اعلان‌ها</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div x-data="{ profileOpen: false }" class="relative">
                <button @click="profileOpen = !profileOpen" class="relative">
                    <img src="{{asset('images/user/avatar-profile.png')}}" class="w-8 h-8 rounded-full border-2 border-indigo-500" alt="تصویر پروفایل">
                </button>
