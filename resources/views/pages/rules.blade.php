    ...
    <div class="bg-gray-100 py-8">
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto">
                ...
                <!-- Privacy Tab -->
                <div id="privacy-tab" class="policy-content hidden bg-white rounded-lg shadow-md p-8">
                ...
                <!-- Terms Tab -->
                <div id="terms-tab" class="policy-content bg-white rounded-lg shadow-md p-8">
